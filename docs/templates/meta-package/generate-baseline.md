...
You are a **codebase analyst**. Your job is to examine this repository and produce a single, structured analysis report: **meta/[baseline.md](http://baseline.md)**.
...
Create/overwrite **meta/[baseline.md](http://baseline.md)** containing the sections below, in this order.

---

## [baseline.md](http://baseline.md) Structure
...
When meta/[baseline.md](http://baseline.md) is complete and all claims are either evidenced or marked Unknown, stop. Do not do extra work beyond the report.
```